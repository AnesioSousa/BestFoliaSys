/*******************************************************************************************
Autor: Anésio Sousa
Componente Curricular: EXA863 - MI - PROGRAMAÇÃO - Algoritmos e Programação II
Concluido em: 25/04/2018
...
public class BFSFacade {
	...
	public Transporte cadastrarTransporte(String nome, String tipo, double valor, int capacidade, 
            ...
            return controller.cadastrarTransporte(nome, tipo, valor, capacidade, saida, localSaida, retorno, localRetorno, chegada, localChegada, bloco);
	}
